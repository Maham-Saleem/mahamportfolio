          ...
          >
            ...
            >
              <button
                ...
                className="group px-8 py-3.5 gradient-bg text-white rounded-full font-medium shadow-lg shadow-primary/25 hover:shadow-xl hover:shadow-primary/30 hover:-translate-y-0.5 transition-all duration-300 flex items-center gap-2 min-w-[155px] justify-center"
              >
                View Projects
              ...
              <a
                ...
                download
                className="px-8 py-3.5 rounded-full font-medium border-2 border-border text-text-secondary hover:border-primary/30 hover:text-primary hover:-translate-y-0.5 transition-all duration-300 flex items-center gap-2 min-w-[155px] justify-center"
              >
                <Download size={16} />
                Download CV
              </a>
